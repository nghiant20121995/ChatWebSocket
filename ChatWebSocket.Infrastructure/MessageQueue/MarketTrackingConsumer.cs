...
namespace ChatWebSocket.Infrastructure.MessageQueue
{
    public class ChatWebSocketTrackingConsumer : BackgroundService
    {
        private readonly ILogger<ChatWebSocketTrackingConsumer> _logger;
        private readonly IServiceProvider _serviceProvider;
        private readonly IConfiguration _configuration;
        protected virtual string _topicName { get; set; }
        protected virtual int _consumerSize { get; set; }

        public ChatWebSocketTrackingConsumer(IConfiguration configuration, 
            ILogger<ChatWebSocketTrackingConsumer> logger, 
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            _logger.LogInformation($"----------------------------------------- start Subscribe {typeof(ChatWebSocketTrackingConsumer).Name} -----------------------------------------------");
        ...
        private async Task SubExecuteAsync(int indexConsumer, CancellationToken stoppingToken)
        {
            ...
            //var groupId = "ChatWebSocket-import";
            ...
            //            var importedFile = JsonSerializer.Deserialize<User>(consumeResult.Message.Value);
